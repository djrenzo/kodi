...
class SkipOverlay(xbmcgui.WindowXMLDialog):
    ...
    def onInit(self) -> None:
        ...
        try:
            ...
            xbmc.log('[SkipDB] Overlay background textures: {}'.format(e), xbmc.LOGWARNING)
        ...
        try:
            ...
            xbmc.log('[SkipDB] Failed to set button text: {}'.format(e), xbmc.LOGWARNING)
    ...
    def _close_from_bg_thread(self) -> None:
        ...
        try:
            ...
            xbmc.log('[SkipDB] Overlay close failed: {}'.format(e), xbmc.LOGWARNING)
...
def show_skip_overlay(callback: Optional[Callable[[], None]] = None, intro_end: Optional[float] = None,
    ...
    try:
        ...
        xbmc.log('[SkipDB] Overlay error: {}'.format(e), xbmc.LOGERROR)
        return False
