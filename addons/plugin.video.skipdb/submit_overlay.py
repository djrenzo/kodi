...
#
# submit_overlay.py — overlay for marking segment start/end timestamps during playback
...
class SubmitMarkOverlay(xbmcgui.WindowXMLDialog):
    """Single-button overlay that says 'Mark Segment Start' or 'Mark Segment End'."""
    ...
    def onInit(self) -> None:
        ...
        try:
            ...
            xbmc.log('[SkipDB] Submit overlay textures: {}'.format(e), xbmc.LOGWARNING)
        ...
        try:
            ...
            xbmc.log('[SkipDB] Submit overlay set label: {}'.format(e), xbmc.LOGWARNING)
    ...
    def _close_from_bg_thread(self) -> None:
        ...
        try:
            ...
            xbmc.log('[SkipDB] Submit overlay close failed: {}'.format(e), xbmc.LOGWARNING)
...
def show_submit_mark_overlay(label_text: str, player: Optional[xbmc.Player] = None,
    ...
    try:
        ...
        xbmc.log('[SkipDB] Submit overlay error: {}'.format(e), xbmc.LOGERROR)
        return False
